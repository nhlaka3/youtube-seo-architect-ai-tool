...
const GLOSSARY_TERMS = [
  ...
  { slug: 'video-editing', nameEN: 'Video Editing', nameES: 'Edición de Video', defEN: 'Video Editing is the process of arranging and modifying video clips to create a final product.', defES: 'La Edición de Video es el proceso de organizar y modificar clips de video para crear un producto final.' },
  { slug: 'thumbnail', nameEN: 'Thumbnail', nameES: 'Miniatura', defEN: 'A Thumbnail is a clickable preview image that represents a YouTube video.', defES: 'Una Miniatura es una imagen de vista previa que representa un video de YouTube.' },
  { slug: 'description', nameEN: 'Video Description', nameES: 'Descripción del Video', defEN: 'The Video Description is a text field below your video that provides context, links, and keywords.', defES: 'La Descripción del Video es un campo de texto debajo de tu video que proporciona contexto, enlaces y palabras clave.' },
  { slug: 'tags', nameEN: 'Tags', nameES: 'Etiquetas', defEN: 'Tags are keywords that help YouTube understand the content and context of your video.', defES: 'Las Etiquetas son palabras clave que ayudan a YouTube a entender el contenido y contexto de tu video.' },
  { slug: 'engagement', nameEN: 'Engagement', nameES: 'Participación', defEN: 'Engagement measures how users interact with your content through likes, comments, and shares.', defES: 'La Participación mide cómo los usuarios interactúan con tu contenido a través de Me gusta, comentarios y compartidos.' },
  { slug: 'retention', nameEN: 'Retention', nameES: 'Retención', defEN: 'Retention is the percentage of a video that viewers watch, indicating content quality.', defES: 'La Retención es el porcentaje de un video que los espectadores ven, indicando la calidad del contenido.' },
  { slug: 'playlist', nameEN: 'Playlist', nameES: 'Lista de Reproducción', defEN: 'A Playlist is a curated collection of videos organized around a theme or topic.', defES: 'Una Lista de Reproducción es una colección curada de videos organizados alrededor de un tema.' },
  { slug: 'cards', nameEN: 'Cards', nameES: 'Tarjetas', defEN: 'Cards are interactive elements that appear as teasers within a video, linking to other content.', defES: 'Las Tarjetas son elementos interactivos que aparecen como avances dentro de un video.' },
  { slug: 'end-screen', nameEN: 'End Screen', nameES: 'Pantalla Final', defEN: 'An End Screen displays recommended videos and subscribe buttons in the last 20 seconds of a video.', defES: 'Una Pantalla Final muestra videos recomendados y botones de suscripción en los últimos 20 segundos de un video.' },
  { slug: 'closed-captions', nameEN: 'Closed Captions', nameES: 'Subtítulos', defEN: 'Closed Captions display spoken dialogue and audio cues as text on screen.', defES: 'Los Subtítulos muestran el diálogo hablado y señales de audio como texto en pantalla.' },
  { slug: 'chapter', nameEN: 'Chapters', nameES: 'Capítulos', defEN: 'Chapters divide a video into timed segments with descriptive titles for easier navigation.', defES: 'Los Capítulos dividen un video en segmentos temporizados con títulos descriptivos para una navegación más fácil.' },
  { slug: 'community', nameEN: 'Community Tab', nameES: 'Pestaña Comunidad', defEN: 'The Community Tab lets creators post text, images, and polls to engage their audience.', defES: 'La Pestaña Comunidad permite a los creadores publicar texto, imágenes y encuestas para interactuar con su audiencia.' },
  { slug: 'brand', nameEN: 'Brand Channel', nameES: 'Canal de Marca', defEN: 'A Brand Channel is a YouTube channel specifically for businesses or brands.', defES: 'Un Canal de Marca es un canal de YouTube específicamente para negocios o marcas.' },
  { slug: 'distribution', nameEN: 'Content Distribution', nameES: 'Distribución de Contenido', defEN: 'Content Distribution is the process of sharing your video across multiple platforms to maximize reach.', defES: 'La Distribución de Contenido es el proceso de compartir tu video en múltiples plataformas para maximizar el alcance.' },
  { slug: 'copyright', nameEN: 'Copyright', nameES: 'Derechos de Autor', defEN: 'Copyright is legal protection of original creative works, enforced by YouTube\'s Content ID system.', defES: 'Los Derechos de Autor son la protección legal de obras creativas originales, aplicada por el sistema Content ID de YouTube.' },
  { slug: 'fair-use', nameEN: 'Fair Use', nameES: 'Uso Justo', defEN: 'Fair Use allows limited use of copyrighted material without permission for purposes like commentary.', defES: 'El Uso Justo permite el uso limitado de material protegido sin permiso para fines como comentarios.' },
  { slug: 'hashtag', nameEN: 'Hashtags', nameES: 'Hashtags', defEN: 'Hashtags are clickable keywords preceded by # that help categorize content by topic.', defES: 'Los Hashtags son palabras clave precedidas por # que ayudan a categorizar el contenido por tema.' },
  { slug: 'live-stream', nameEN: 'Live Stream', nameES: 'Transmisión en Vivo', defEN: 'A Live Stream is a real-time video broadcast that allows viewer interaction.', defES: 'Una Transmisión en Vivo es una emisión de video en tiempo real que permite la interacción con los espectadores.' },
  { slug: 'premiere', nameEN: 'Premiere', nameES: 'Estreno', defEN: 'A Premiere is a scheduled first showing of a pre-recorded video with live chat.', defES: 'Un Estreno es una primera proyección programada de un video pregrabado con chat en vivo.' },
  { slug: 'pinned-comment', nameEN: 'Pinned Comment', nameES: 'Comentario Fijado', defEN: 'A Pinned Comment is highlighted at the top of the comments section for visibility.', defES: 'Un Comentario Fijado se destaca en la parte superior de la sección de comentarios para mayor visibilidad.' },
  { slug: 'comment', nameEN: 'Comments', nameES: 'Comentarios', defEN: 'Comments are viewer responses to a video that drive engagement and community.', defES: 'Los Comentarios son respuestas de los espectadores a un video que impulsan la participación y la comunidad.' },
  { slug: 'calls-to-action', nameEN: 'Calls-to-Action (CTA)', nameES: 'Llamadas a la Acción (CTA)', defEN: 'CTAs prompt viewers to take a specific action like subscribing or clicking a link.', defES: 'Las CTA invitan a los espectadores a realizar una acción específica como suscribirse o hacer clic en un enlace.' },
  { slug: 'hook', nameEN: 'Hook', nameES: 'Gancho', defEN: 'A Hook is the first few seconds of a video designed to grab viewer attention.', defES: 'Un Gancho son los primeros segundos de un video diseñados para captar la atención del espectador.' },
  { slug: 'intro', nameEN: 'Intro', nameES: 'Introducción', defEN: 'An Intro is the opening segment of a video that sets expectations and branding.', defES: 'Una Introducción es el segmento de apertura de un video que establece expectativas y marca.' },
  { slug: 'outro', nameEN: 'Outro', nameES: 'Cierre', defEN: 'An Outro is the closing segment that summarizes and encourages viewer action.', defES: 'Un Cierre es el segmento final que resume y fomenta la acción del espectador.' },
  { slug: 'branding', nameEN: 'Channel Branding', nameES: 'Identidad de Marca', defEN: 'Channel Branding includes your profile picture, banner, and visual identity across YouTube.', defES: 'La Identidad de Marca incluye tu foto de perfil, banner e identidad visual en YouTube.' },
  { slug: 'vanity-url', nameEN: 'Vanity URL', nameES: 'URL Personalizada', defEN: 'A Vanity URL is a custom YouTube channel URL (e.g., youtube.com/@handle).', defES: 'Una URL Personalizada es una URL personalizada del canal de YouTube (ej., youtube.com/@handle).' },
  { slug: 'handle', nameEN: 'YouTube Handle', nameES: 'Identificador de YouTube', defEN: 'A YouTube Handle (@handle) is a unique identifier for your channel used in mentions.', defES: 'Un Identificador de YouTube (@handle) es un identificador único para tu canal usado en menciones.' },
  { slug: 'analytics', nameEN: 'YouTube Analytics', nameES: 'Analíticas de YouTube', defEN: 'YouTube Analytics provides data on video performance, audience, and revenue.', defES: 'Las Analíticas de YouTube proporcionan datos sobre el rendimiento del video, la audiencia y los ingresos.' },
  { slug: 'real-time', nameEN: 'Real-Time Analytics', nameES: 'Analíticas en Tiempo Real', defEN: 'Real-Time Analytics shows immediate viewer activity data on your content.', defES: 'Las Analíticas en Tiempo Real muestran datos de actividad inmediata de los espectadores en tu contenido.' },
  { slug: 'traffic-source', nameEN: 'Traffic Source', nameES: 'Fuente de Tráfico', defEN: 'Traffic Source indicates where viewers found your video (search, suggested, external).', defES: 'La Fuente de Tráfico indica dónde encontraron los espectadores tu video (búsqueda, sugerido, externo).' },
  { slug: 'demographics', nameEN: 'Audience Demographics', nameES: 'Demografía de Audiencia', defEN: 'Audience Demographics shows the age, gender, and location of your viewers.', defES: 'La Demografía de Audiencia muestra la edad, género y ubicación de tus espectadores.' },
  { slug: 'reach', nameEN: 'Reach', nameES: 'Alcance', defEN: 'Reach is the total number of unique users who see your content.', defES: 'El Alcance es el número total de usuarios únicos que ven tu contenido.' },
  { slug: 'views', nameEN: 'Views', nameES: 'Vistas', defEN: 'Views count the number of times your video has been watched.', defES: 'Las Vistas cuentan el número de veces que se ha visto tu video.' },
  { slug: 'subscriber', nameEN: 'Subscribers', nameES: 'Suscriptores', defEN: 'Subscribers are users who follow your channel to receive updates.', defES: 'Los Suscriptores son usuarios que siguen tu canal para recibir actualizaciones.' },
];
